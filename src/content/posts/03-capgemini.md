...
With hardly any introduction, I had to work with the whole team. Being given a lot of tasks from day one (and on top of that starting in a position of responsibility) was a great challenge, I must admit. For almost no pay, I must add.

Unfortunately, I was all alone in every aspect. But ey, I was given the opportunity to train extensively with tools widely used in the industry.

> Rating: **0/10**. If I had to recommend someone to work for this company, unfortunately, I would not. The working conditions are deplorable, meaning the hours are grueling and the pay is miserable no matter where you live in Spain. 
...
**The first** is that, while I like to manage infrastructure... performing a large number of tasks per sprint at the same time was exhausting. I had to take care of helping the development staff, while maintaining the kubernetes cluster that contained the infrastructure of Dutch government. It was too much responsibility for the minimum wage. 
